...
<html>
<head>
<title>All Advertise | CC News</title>
                            ...
                            if(isset($_GET['ids']))
                            {
                                ...
                                $_SESSION['fd']=$catid;
                                 ...
                                 $ct=$_SESSION['fd'];
                                        ...
                                        $edit = mysqli_query($con,"delete from ad where id = $ct");
					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							<div class="form-title">
								<h4>Add <small>Advertisment</small> :</h4>
							</div>
                    ...
                    $post_img = $row_ca_pro[1];
                        ...
                        ?>
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                <img src="advertisment/<?php echo $post_img; ?>" alt="ad img" width="100px;" height="50px;">
                                               </td>
                                               
                                               <td>
                                                    <a href="<?php echo "all_add.php?ids=$id";    ?>"><span style="font-size:20px;"><i class="fa fa-trash-o"></i></span></a>
                                               </td>
                                        </tr>
