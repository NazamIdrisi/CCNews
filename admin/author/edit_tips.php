					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
                           ...
                           <?php
                            ...
                            $edit = mysqli_query($con,"Update tips set cat_title='$cat_box',title_box='$name',msg_box='$msg_box',tag_box='$tag_box',img_box='$img_box' where post_id = $ct");
                            ...
                            ?>
							<div class="form-body">
								<form class="form-horizontal" action="edit_tips.php" method="post" enctype="multipart/form-data">    
