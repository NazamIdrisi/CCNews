                            ...
                            if(isset($_GET['ids']))
                            {
                                ...
                                $_SESSION['fd']=$catid;
                                 ...
                                 $ct=$_SESSION['fd'];
                                        ...
                                        $edit = mysqli_query($con,"delete from comment where id = $ct");
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							<div class="form-title">
								<h4>All <small>comments</small> :</h4>
							</div>
                ...
                $get_cat_pro = "select * from comment ";
...
//}
                while($row_ca_pro=mysqli_fetch_array($run_cat_pro)){
                    ...
                    $id=$row_ca_pro['id'];
                    $firstname = $row_ca_pro['firstname'];
                    $lastname = $row_ca_pro['lastname'];
                    ...
                    $cmt = $row_ca_pro['cmt'];
                        ...
                        ?>
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                    <a href="<?php echo "comment.php?ids=$id";    ?>"><span style="font-size:20px;"><i class="fa fa-trash-o"></i></span></a>
                                               </td>
                                        </tr>
