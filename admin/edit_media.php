					...
					<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
                           ...
                           <?php
                            ...
                            $edit = mysqli_query($con,"Update video set cat_title='$cat_box',title_box='$name',msg_box='$msg_box',tag_box='$tag_box',video_box='$img_box' where post_id = $ct");
                            
                            move_uploaded_file($_FILES['img_box']['tmp_name'],"post_video/".$img_box);

                           
                            echo "<script>alert('Updated Post')</script>";
                            ...
                            ?>
							<div class="form-body">
								<form class="form-horizontal" action="edit_media.php" method="post" enctype="multipart/form-data">    
