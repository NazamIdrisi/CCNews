...
<html>
<head>
<title>All Contact | CC News</title>
                            ...
                            if(isset($_GET['ids']))
                            {
                                ...
                                $_SESSION['fd']=$catid;
                                 ...
                                 $ct=$_SESSION['fd'];
                                        ...
                                        $edit = mysqli_query($con,"delete from contact where id = $ct");
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
                ...
                $get_cat_pro = "select * from contact ";
                    ...
                    $address = $row_ca_pro['address'];
                        ...
                        ?>
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                    <a href="<?php echo "update_contact.php?ids=$id";    ?>"><span style="font-size:20px;"><i class="fa fa-trash-o"></i></span></a>
                                               </td>
                                        </tr>
