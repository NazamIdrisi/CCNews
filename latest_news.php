...
<head>
    ...
    <title>Latest_news | CC News</title>
    ...
    <div class="wrapper">
        ...
        <section id="page-content" class="page-wrapper">
            ...
            <div class="zm-section bg-white pt-70 pb-40">
                            ...
                            <div class="row mb-40">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="section-title">
                                        <h2 class="h6 header-color inline-block uppercase">Tages</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                $get_cat_pro = "select * from po LIMIT 0,80";
                                                ...
                                                <div class='zm-post-header'>
                                                    ...
                                                    <div class='zm-post-meta'>
                                                        <ul>
                                                            ...
                                                            <li class='s-meta'><a href='#' class='zm-date'>$post_time</a></li>
                                                        </ul>
                                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 col-lg-12 xs-mt-40 sm-mt-50 md-mt-60">
                                    <aside class="subscribe-form bg-dark text-center sidebar">
                                        ...
                                        <form action="tag_news.php" method="post">
