    ...
    <div class="wrapper">
        ...
        <div id="page-content" class="page-wrapper">
            <div class="zm-section single-post-wrap bg-white ptb-70 xs-pt-30">
                ...
                $get_cat_pro = "select * from tips where post_id='$post_id'";
                       ...
                       ?>
                            ...
                            <article class="zm-post-lay-single">
                                        <div class="zm-post-thumb">
                                            <a href="tips_d.php?post_id=<?php echo $post_id; ?>"><img src="admin/tips_images/<?php echo $post_img ;?>" alt="img" height="400px;"></a>
                                        </div>
